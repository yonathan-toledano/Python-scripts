...
Tested with standard Python libraries; no external modules required
...
largest_and_smallest.py	Finds the largest and smallest numbers from user input.
math_print.py	Prints arithmetic results (addition, subtraction, multiplication, division).
...
Navigate to the script folder, for example:
...
They focus on readability, simplicity, and learning fundamental Python concepts.
...
Include more interactive scripts and games

Expand with file handling and data manipulation examples
